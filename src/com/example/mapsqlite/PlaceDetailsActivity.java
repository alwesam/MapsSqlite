...
public class PlaceDetailsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sb.append("&key=AIzaSyB2qfjsaJDfEcB2BfKHSTIx48C_2k0eefY");
        
        firsturl = sb.toString();
    ...
    private class PlacesTask extends AsyncTask<String, Integer, String>{
        ...
        protected String doInBackground(String... url) {
            try{
                ...
                urldownload = "download success!";
            }catch(Exception e){
                Log.d("Background Task",e.toString());  
                urldownload = "download fail!";
            }
            return data;
        }
    ...
    private class ParserTask extends AsyncTask<String, Integer, HashMap<String,String>>{
        ...
        protected HashMap<String,String> doInBackground(String... jsonData) {
            ...
            try{
                ...
                debugresult = "Success Parsing!";
 
            }catch(Exception e){
                Log.d("Exception",e.toString());
                debugresult = "Big Fail (parsing)!";
            }
        ...
        protected void onPostExecute(HashMap<String,String> hPlaceDetails){  
           ...
           /* String name = hPlaceDetails.get("name");
            ...
            String data = "<html>"+
                    "<body><h1><center>TEST</center></h1>" +
                    "<br style='clear:both' />" +
                    "<hr />"+
                    "<p>Parsing : " + debugresult + "</p>" +  
                    "<p>SBtoString : " + firsturl + "</p>" + 
                    "<p>url[0] : " + whatisurl + "</p>" + 
                    "<p>Connection : " + urlconn + "</p>" + 
                    "<p>Download : " + urldownload + "</p>" + 
                    "<p>WEBDATA : " + urldata + "</p>" +  
                    "</body></html>";
