...
public class NewLocationActivity extends Activity {
	...
	public void addNewLocation(View view) {
		...
		// comment: this is something peculiar in java where "null" will be
		// assigned
		...
		if (group_sel.equals("null") || group_sel.equals("")) {
			Toast.makeText(getApplicationContext(),
					"Create or join a group to choose from", Toast.LENGTH_LONG)
					.show();
			return;
		}
	...
	// TODO there is an occasional problem with Network locator (in which case
	// the phone
	...
	private class GetAddressTask extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... params) {
			...
			LatLng loc = new LatLng(Double.parseDouble(splited[0]),
