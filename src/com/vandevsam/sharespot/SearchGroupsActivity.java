...
public class SearchGroupsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (list.isEmpty()) {
			Toast.makeText(this, "Empty list, did you checkout groups?",
		...
		/**
		 * searchListAdapter = new ArrayAdapter<String>( //the current context
		 * (this fragement's parent activity) this, //ID of list item layout
		 * R.layout.list_search_item, //ID of textView to populate
		 * R.id.list_search_item_textview, //forecast data list);
		 **/
			...
			public void onItemClick(AdapterView<?> adapterView, View view,
				...
				if (data.queryGroup(group)) {
					if (data.queryStatus(group))
						detailActivity = new Intent(getBaseContext(),
								MyGroupDetailActivity.class).putExtra("key",
								group);
					else
						detailActivity = new Intent(getBaseContext(),
								GroupDetailActivity.class).putExtra("key",
								group);
