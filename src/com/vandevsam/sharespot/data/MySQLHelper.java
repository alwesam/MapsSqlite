...
public class MySQLHelper extends SQLiteOpenHelper {
	...
	public static final String GROUP_DESC = "group_description"; // brief
																	// description
	public static final String GROUP_TYPE = "group_type"; // open, closed, or
															// secret
	...
	private static final String MARKERS_TABLE_CREATE = "create table "
			+ MARKER_TABLE + "(" + COLUMN_ID
			+ " integer primary key autoincrement, " + TITLE + " text, "
			+ SNIPPET + " text, " + POSITION + " text, " + GROUPS + " text, "
			+ STATUS + " text );";
	...
	private static final String GROUPS_TABLE_CREATE = "create table "
			...
			+ GROUP_DESC + " text, " + GROUP_TYPE + " text, " + GROUP_STATUS
			+ " text );";
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		...
		Log.w(MySQLHelper.class.getName(), "Upgrading database from version "
