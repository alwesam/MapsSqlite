...
public class CreateGroupActivity extends Activity {
	...
	public void addNewGroup(View view) {
		...
		if (group.equals("null") || group.equals("")) {
			Toast.makeText(getApplicationContext(), "Enter a group name",
		...
		if (!data.queryGroup(group)) {
			data.createGroup(new MyGroupObj(group, description, group_type,
					"yes"));
		} else {
			Toast.makeText(getApplicationContext(),
					"Group of this name already exists", Toast.LENGTH_LONG)
					.show();
			return;
		}
		data.close();
		...
		ServerUtilFunctions gr = new ServerUtilFunctions(this,
				"Creating the group....");
